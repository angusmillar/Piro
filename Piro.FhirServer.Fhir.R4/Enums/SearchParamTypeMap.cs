...
{
  public class SearchParamTypeMap : MapBase<Piro.FhirServer.Domain.Enums.SearchParamType, Hl7.Fhir.Model.SearchParamType>
  {
    private Dictionary<Piro.FhirServer.Domain.Enums.SearchParamType, Hl7.Fhir.Model.SearchParamType> _ForwardMap;
    private Dictionary<Hl7.Fhir.Model.SearchParamType, Piro.FhirServer.Domain.Enums.SearchParamType> _ReverseMap;
    protected override Dictionary<Piro.FhirServer.Domain.Enums.SearchParamType, Hl7.Fhir.Model.SearchParamType> ForwardMap { get { return _ForwardMap; } }
    protected override Dictionary<Hl7.Fhir.Model.SearchParamType, Piro.FhirServer.Domain.Enums.SearchParamType> ReverseMap { get { return _ReverseMap; } }
    public SearchParamTypeMap()
    {
      _ForwardMap = new Dictionary<Piro.FhirServer.Domain.Enums.SearchParamType, Hl7.Fhir.Model.SearchParamType>();
