...
using Piro.FhirServer.Fhir.R4.Indexing.Setter.Support;
...
namespace Piro.FhirServer.Fhir.R4.Indexing.Setter
{
  public class R4DateTimeSetter : IR4DateTimeSetter
  {
    ...
    public R4DateTimeSetter(IR4DateTimeIndexSupport IDateTimeIndexSupport,  Piro.FhirServer.Domain.DateTimeTools.IFhirDateTimeFactory IFhirDateTimeFactory)
    {
