...
namespace Piro.FhirServer.Fhir.R4.Indexing.Setter
{
  public class R4ReferenceSetter : IR4ReferenceSetter
  {
    ...
    public async Task<IList<IndexReference>> SetAsync(ITypedElement typedElement,  Piro.FhirServer.Domain.Enums.ResourceType resourceType, int searchParameterId, string searchParameterName)
    {
