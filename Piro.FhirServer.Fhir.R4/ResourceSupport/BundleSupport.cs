...
namespace Piro.FhirServer.Fhir.R4.ResourceSupport
{
  ...
  {
    public Piro.FhirServer.Domain.FhirTools.FhirResource GetFhirResource(BundleModel bundleModel)
    {
      ...
      return new Piro.FhirServer.Domain.FhirTools.FhirResource(Piro.FhirServer.Domain.Enums.FhirVersion.R4) { R4 = Bundle };
    }
  }
}
